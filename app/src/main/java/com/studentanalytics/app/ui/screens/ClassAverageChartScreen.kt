...
fun ClassAverageChartScreen(
    ...
    Column(
        ...
        TopAppBar(
            title = { Text("Class Average Chart") },
            navigationIcon = {
        ...
        Column(
            ...
            Text(
                text = "Generate Class Average Chart",
                style = MaterialTheme.typography.headlineSmall
            )
            
            Text(
                text = "This bar chart compares class averages by subject and performance metrics.",
                ...
                Column(
                    ...
                    Button(
                        onClick = {
                            ...
                            viewModel.generateClassAverageChart(
                                ChartRequest(
                                    classId = classId,

...
@Composable
fun PerformanceDistributionChartScreen(
    onBack: () -> Unit,
    ...
    Column(
        ...
        TopAppBar(
            title = { Text("Performance Distribution Chart") },
            navigationIcon = {
        ...
        Column(
            ...
            Text(
                text = "Generate Performance Distribution Chart",
                style = MaterialTheme.typography.headlineSmall
            )
            
            Text(
                text = "This pie chart shows grade distribution across an entire class.",
                ...
                Column(
                    ...
                    Button(
                        onClick = {
                            ...
                            viewModel.generatePerformanceDistributionChart(
                                ChartRequest(
                                    classId = classId,
                        ...
                        modifier = Modifier.fillMaxWidth(),
                        enabled = classId.isNotBlank() && !uiState.isLoading
                    ) {
                        Text("Generate Chart")
                    }
